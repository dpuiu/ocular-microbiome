    ...
    $(function () {
        $('table.docutils.align-default').each(function () {
            ...
            var dt = $table.DataTable({
                ...
                columnDefs: [
                   {
                    ...
                    {         
                        ...
                        render: function (data, type, row, meta) {
                            ...
                            if ($.isNumeric(text)) {
                                return '<a href="https://data.idies.jhu.edu/OcularMicrobiome/Consortium_data/BCM/Illumina_WGS/' + ntext + '.unmapped.fastq.gz"' +
 	           ...
 	           {
		       targets: [5, 6, 7, 8, 9, 12, 13, 14, 15, 16, 17, 18],
	               visible: false
        	    }
